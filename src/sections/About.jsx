    ...
    md:auto-rows-[18rem] mt-12">
      ...
      <div className="flex items-end grid-default-color grid-1">
        <img src="assets/coding-pov.png" alt=""
          className="absolute scale-[1.75rem] -right-[5rem] -top-[1rem]
        md:scale-[3] md:left-50 md:inset-y-10 lg:scale-[2.5]"/>
        <div className="z-10">
          <p className="headtext ">Hi I'm Sahil Singh</p>

          <p className="subtext">Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia quidem culpa labore soluta obcaecati tenetur cumque rerum.
            Architecto quisquam, eum quae rerum odio accusantium,
            magni corrupti et quis harum nemo?</p>
        </div>
        <div className="absolute inset-x-0 pointer-evets-none -bottpom-4 h-1/2 sm:h-1/3 bg-gradient-to-t from-indigo">
      ...
      <div className="grid-black-color grid-3">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">I'm Based in India and open to <br />  remote work worldwide</p>
      ...
      <div className="grid-default-color grid-5">
        <div className="z-10 w-[50%] ">
          ...
          <p className="subtext">I specialize in variety of languages </p>
        </div>
